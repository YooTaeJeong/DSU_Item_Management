...
public class deleteItemsActivity extends AppCompatActivity {
    ...
    public void deletefrmdatabase()
    {
        ...
        if(!TextUtils.isEmpty(deletebarcodevalue)){
            ...
            Toast.makeText(deleteItemsActivity.this," 아이템이 성공적으로 삭제 되었습니다 ! ",Toast.LENGTH_SHORT).show();
        }
        else{
            Toast.makeText(deleteItemsActivity.this," 바코드를 스캔해주세요 ! ",Toast.LENGTH_SHORT).show();
        }
    }
}
